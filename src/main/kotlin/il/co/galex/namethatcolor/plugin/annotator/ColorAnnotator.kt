...
import org.jetbrains.kotlin.psi.stubs.elements.KtStubElementTypes.INTEGER_CONSTANT
...
class ColorAnnotator : Annotator {
    ...
    override fun annotate(element: PsiElement, holder: AnnotationHolder) {
        ...
        try {
            if (element.containingFile.fileType.name.lowercase() == "kotlin" &&
                element.elementType in setOf(IDENTIFIER, INTEGER_CONSTANT)) {
